/**
 * The {@code UnsortedTableMapTest} in this class implements a
 * junit test for an Unsorted Table map.
 *
 * @author Ahmed Jouda
 */
...
class UnsortedTableMapTest {
	...
	@Test
	void testSize() {
		UnsortedTableMap<Integer, String> map = new UnsortedTableMap<Integer, String>();
	...
	@Test
	void testGet() {
		UnsortedTableMap<String, Integer> map = new UnsortedTableMap<String, Integer>();
