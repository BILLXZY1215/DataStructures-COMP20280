...
class LinkedBinaryTreeTest {
	...
	@Test
	void testAddLeft() throws IllegalArgumentException, IllegalAccessException {
		LinkedBinaryTree<Integer> bt = new LinkedBinaryTree<Integer>();
	...
	@Test
	void testAddRight() throws IllegalArgumentException, IllegalAccessException {
		LinkedBinaryTree<Integer> bt = new LinkedBinaryTree<Integer>();
	...
	@Test
	void testRemove() throws IllegalArgumentException, IllegalAccessException {
		LinkedBinaryTree<Integer> bt = new LinkedBinaryTree<Integer>();
